...
PROMPT_1_2 = """In PORT_YTO_AI.PORT_OPS, the 10 CSV files have been uploaded to an internal stage called DATA.
...
1. Download all files from [github.com/sfc-gh-obenning/coco-hol-toronto/tree/main/workshop_guide/data](https://github.com/sfc-gh-obenning/coco-hol-toronto/tree/main/workshop_guide/data):
...
2. Using Snowsight, use the Horizon Catalog to browse to the `PORT_YTO_AI.PORT_OPS.DATA` stage to upload all 10 files.
...
CREATE OR REPLACE TABLE TERMINALS
  USING TEMPLATE (
    ...
    FROM TABLE(INFER_SCHEMA(
      LOCATION => '@PORT_YTO_AI.PORT_OPS.DATA/terminals.csv',
      FILE_FORMAT => 'csv_format'
    ))
  );

COPY INTO TERMINALS
  FROM @PORT_YTO_AI.PORT_OPS.DATA/terminals.csv
  FILE_FORMAT = csv_format;
```
